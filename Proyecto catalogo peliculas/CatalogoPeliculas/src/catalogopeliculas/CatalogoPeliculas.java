...
import murcia.fernando.peliculas.negocio.CatalogoPeliculasImpl;
...
public class CatalogoPeliculas {
    ...
    private static final String nombreArchivo = "C:\\Users\\fernando.murcia\\Documents\\Fernando\\ProyectosJava\\CatalogoPeliculas\\Proyecto catalogo peliculas\\CatalogoPeliculas\\Peliculas.txt";
    ...
    private void iniciarArchivo(String nombreArchivo) {
       
    }

    private void agregarPelicula(String nombre, String nombreArchivo) {
        
    }

    private void listarPeliculas(String nombreArchivo) {
        
    }

    private void buscarPelicula(String nombreArchivo, String buscar) {
